...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_FILES['imagen']) && $_FILES['imagen']['error'] == 0) {
        $uploadsDir = 'uploads/'; // Directorio donde se guardarán las imágenes
    ...
    $sql = "INSERT INTO proyectos (titulo, descripcion_breve, imagen, descripcion_extensa)
            VALUES ('$titulo', '$descripcion_breve', '$imagePath', '$descripcion_extensa')";
